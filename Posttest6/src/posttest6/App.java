...
public class App {
    ...
    static BufferedReader buff = new BufferedReader(input);
...
//            }
    ...
    static void ubahData()throws IOException {
        ...
        if (menu3 == 1) {
            System.out.print("Masukan nama Merk : ");
            String carihlm = buff.readLine();
            for (FullFace hlm : dtfullface) {
                if (hlm.getMerk().equals(carihlm)) {
                    System.out.print("Merk : ");
                    hlm.SetMerk(buff.readLine());
                    System.out.print("Harga : ");
                    hlm.SetHarga(Integer.parseInt(buff.readLine()));
                    System.out.print("Ukuran : ");
                    hlm.setUkuran(buff.readLine());
                }
            }
            ...
            for (HalfFace hlm : dthalfface) {
                if (hlm.getMerk().equals(carihlm)) {
                    ...
                    System.out.print("Harga : ");
                    hlm.SetHarga(Integer.parseInt(buff.readLine()));
                    System.out.print("Warnan : ");
                    hlm.setWarna(buff.readLine());
                }
            }
