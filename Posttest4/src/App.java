...
public class App {
    ...
    static ArrayList<Helm> pendataanHelm = new ArrayList<>(){
        {
            add(new Helm("SNI", 10000 ));
            add(new Helm("SNI2", 10000));
        }
    };
    static ArrayList<FullFace> dtfullface = new ArrayList<>(){
        {
            add(new FullFace("KYT", 10000, "L"));
            add(new FullFace("NHK", 12000, "M"));
        }
    };

    static ArrayList<HalfFace> dthalfface = new ArrayList<>(){
        {
            add(new HalfFace("Bogo", 11000, "Biru" ));
            add(new HalfFace("Kiwi", 13000, "Hijau" ));
        }
    };
        ...
        do { bersihkan();
            ...
            switch (menu) {
                ...
                switch (menu1) {
                    ...
                    FullFace FullFacec = new FullFace(merk, harga, ukuran);
                    ...
                    HalfFace halfFace = new HalfFace(merk1, harga1, warna1);
